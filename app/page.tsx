...
export default function Home() {
  ...
  const [gameState, setGameState] = useState<"lobby" | "waiting" | "game">(
    "lobby"
  );
  ...
  const handleCreateRoom = (playerName: string) => {
    console.log("handleCreateRoom called with playerName:", playerName);
    ...
    if (!playerName || !playerName.trim()) {
      console.log("handleCreateRoom - playerName is empty:", playerName);
      notifications.error("Error", "Please enter your name");
      return;
    }

    const trimmedName = playerName.trim();
    console.log("Creating room with playerName:", trimmedName);
  ...
  const handleJoinRoom = (code: string) => {
    ...
    console.log("Joining room:", code, "with playerName:", playerName);
    setIsLoading(true);
  ...
  const handleGameStart = (data: string, creator: boolean) => {
    console.log("Game start requested:", { data, creator });
