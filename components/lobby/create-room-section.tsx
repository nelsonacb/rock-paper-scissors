...
import { CreateRoomSectionProps } from "@/interfaces";
...
export function CreateRoomSection({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("CreateRoomSection handleSubmit - playerName:", trimmedName);

    if (!trimmedName) {
      console.log("CreateRoomSection - name is empty");
      return;
    }

    useGameStore.setState({ playerName: trimmedName });
    console.log("CreateRoomSection calling onRoomCreated with:", trimmedName);
    ...
    return (
      <div className="card-base text-center space-y-6">
        ...
        <div className="bg-muted p-6 rounded-lg border-2 border-primary/20">
          ...
          <p className="text-5xl font-bold font-mono text-primary mb-6 tracking-wider">
            {generatedCode}
          </p>
          <button
            onClick={copyCode}
